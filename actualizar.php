<?php
    ...
    $consulta = "UPDATE alumnos SET nombre=?, apellido1=?, apellido2=?, dni=?, fecha_nac=?, email=? where id =?";
    // Utilizamos una consulta preparada
    $preparada = mysqli_prepare($conexion, $consulta);
    mysqli_stmt_bind_param($preparada, 'ssssssi', $nombre,$apellido1, $apellido2, $dni, $fechaNac, $email, $id);
